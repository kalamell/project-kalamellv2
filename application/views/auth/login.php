<div class="modal-dialog">
    	<div class="modal-content">
      		...
      		<div class="modal-body login-modal">
      			<p>ยินดีต้อนรับเข้าเป็นส่วนหนึ่งของเรา กรุณาเข้าสู่ระบบครับ </p>
      			<br/>
      			...
      			<div id='social-icons-conatainer'>
	        		<div class='modal-body-left'>
		            	...
		            	<a href="#" class="btn btn-success modal-login-btn">เข้าสู่ระบบ</a>
		            	<a href="#" class="login-link text-center">ลืมรหัสผ่าน?</a>
	        		</div>

	        		<div class='modal-body-right'>
	        			<div class="modal-social-icons">
	        				<a href='' class="btn btn-default facebook"> <i class="fa fa-facebook modal-icons"></i> เข้าสู่ระบบโดย Facebook </a>
	        		...
	        		<div id='center-line'> หรือ </div>
	        	</div>																												
        		<div class="clearfix"></div>

        		<div class="form-group modal-register-btn">
        			<button class="btn btn-default"> สมัครสมาชิกใหม่ </button>
        		</div>
      		</div>
      		<div class="clearfix"></div>
